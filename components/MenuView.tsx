        ...
        <div className="flex gap-3 mb-8">
           ...
           {onOpenVoiceModal && (
             <button
               ...
               className="bg-brand-orange text-white p-4 rounded-2xl shadow-lg hover:bg-brand-gold hover:text-brand-brown transition-all active:scale-95 flex items-center justify-center shrink-0"
