...
export const MENU_ITEMS: MenuItem[] = [
  ...
  { id: 'sp1', name: 'Tiep Royal Khady', description: 'Le chef-d\'œuvre de la maison au poisson capitaine, riz rouge parfumé et légumes fondants.', price: 5500, image: 'https://images.unsplash.com/photo-1627308595229-7830a5c91f9f?w=800', category: 'Spécialité Maison', rating: 5, isAvailable: true, isSpicy: true, isSpécialitéMaison: true },
  ...
  { id: 'dj1', name: 'Dambou du Jour', description: 'Couscous de moringa frais aux arachides grillées, servi avec du poulet braisé.', price: 2500, image: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=800', category: 'Menu du Jour', rating: 4.9, isAvailable: true, isVegetarian: true, isLowPrice: true, isPlatDuJour: true },
  { id: 'dj2', name: 'Riz au Gras Niamey', description: 'Riz savoureux cuit dans un bouillon de viande et épices locales.', price: 2000, image: 'https://images.unsplash.com/photo-1589302168068-964664d93dc0?w=800', category: 'Menu du Jour', rating: 4.7, isAvailable: true, isLowPrice: true, isPlatDuJour: true },

  // --- PETIT-DÉJEUNER ---
  { id: 'pd1', name: 'Café Touba & Beignets Dounguiri', description: 'Café traditionnel sénégalais épicé au poivre de Selim, accompagné de succulents beignets doux de mil frits.', price: 1500, image: 'https://images.unsplash.com/photo-1541167760496-1628856ab772?w=800', category: 'Petit-déjeuner', rating: 4.9, isAvailable: true, isLowPrice: true, isPromo: true },
  ...
  { id: 'dn3', name: 'Saka Saka de Kinshasa', description: 'Mijoté de feuilles de manioc finement pilées avec du poisson capitaine fumé, de la viande de bœuf séchée et de la pâte d\'arachide onctueuse, accompagné de riz parfumé.', price: 4500, image: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=800', category: 'Dîner', rating: 4.7, isAvailable: true, isVegetarian: false },
  ...
  { id: 'en3', name: 'Aloco de Grand-Bassam', description: 'Bananes plantains bien mûres découpées en dés et frites dans une huile végétale fine, dorées à souhait, accompagnées d\'une sauce pimentée Khady.', price: 1500, image: 'https://images.unsplash.com/photo-1563729784474-d77dbb933a9e?w=800', category: 'Entrée', rating: 5, isAvailable: true, isVegetarian: true, isLowPrice: true },
  ...
  // --- BOISSONS NATURELLES ---
  { id: 'bo1', name: 'Bissap Rouge Glacé Royal', description: 'Infusion fraîche et royale de fleurs d\'hibiscus sabdariffa du Niger, parfumée à la menthe douce saharienne et au jus d\'ananas pressé.', price: 500, image: 'https://images.unsplash.com/photo-1556881286-fc6915169721?w=800', category: 'Boisson Naturelle', rating: 5, isAvailable: true, isVegetarian: true, isLowPrice: true, isPromo: true },
  ...
  { id: 'bo3', name: 'Jus de Gingembre Tonique', description: 'Nectar de gingembre frais pressé à froid, adouci par du citron vert et du pur miel sauvage, extrêmement rafraîchissant.', price: 800, image: 'https://images.unsplash.com/photo-1513558161293-cdaf765ed2fd?w=800', category: 'Boisson Naturelle', rating: 4.8, isAvailable: true, isVegetarian: true, isSpicy: true },
  { id: 'bo4', name: 'Jus de Tamarin Douceur', description: 'Boisson rafraîchissante et acidulée à base de tamarin sauvage purifié, légèrement sucrée et infusée d\'eau de rose.', price: 800, image: 'https://images.unsplash.com/photo-1621263764928-df1444c5e859?w=800', category: 'Boisson Naturelle', rating: 4.7, isAvailable: true, isVegetarian: true },

  // --- PLATS AFRICAINS TRANSVERSAUX ---
  { id: 'af3', name: 'Attiéké Poisson Capitaine', description: 'Semoule de manioc cuite, darne de poisson capitaine braisée au bois d\'acacia, oignons blancs et poivrons marinés.', price: 5000, image: 'https://images.unsplash.com/photo-1467003909585-2f8a72700288?w=800', category: 'Plat Africain', rating: 5, isAvailable: true, isSpécialitéMaison: true },

  // --- DESSERTS ---
  { id: 'de1', name: 'Dégué Royal', description: 'Couscous de mil au yaourt onctueux d\'Afrique de l\'Ouest, miel, éclats de coco séchée.', price: 1500, image: 'https://images.unsplash.com/photo-1563805042-7684c019e1cb?w=800', category: 'Dessert', rating: 4.9, isAvailable: true, isVegetarian: true, isLowPrice: true },

  // --- BOX SAUCES (Min 10) ---
  { id: 'bx1', name: 'Box Sauce Mafé', description: 'Onctueuse sauce à l\'arachide pré-cuite, prête à réchauffer pour napper vos riz. Format familial 1L.', price: 4500, image: 'https://images.unsplash.com/photo-1541518763531-4a949439a3f8?w=800', category: 'Box Sauce', rating: 4.8, isAvailable: true, isSpécialitéMaison: true },
  ...
  { id: 'bx8', name: 'Box Piment Feu d\'Afrique', description: 'Purée homogène de piment de Cayenne extra fort et d\'épices secrètes de la maison Khady.', price: 2000, image: 'https://images.unsplash.com/photo-1516824467704-9d4199c98607?w=800', category: 'Box Sauce', rating: 5, isAvailable: true, isSpicy: true, isVegetarian: true },

  // --- PACK-BUFFET (Événements) ---
  { id: 'pb1', name: 'Pack Buffet Mariage', description: 'Buffet complet pour 50 personnes avec entrées, plats de célébration, desserts et service traiteur inclus.', price: 250000, image: 'https://images.unsplash.com/photo-1555244162-803834f70033?w=800', category: 'Pack-Buffet', rating: 5, isAvailable: true, minPeople: 50, isSpécialitéMaison: true },
